...
```{r}
library(readr)
bike_2019_q2 <- read_csv("C:/Users/HP/Downloads/Cyclistic_Bike_Share/bike 2019 q2.csv")
bike_2019_q3<- read_csv("C:/Users/HP/Downloads/Cyclistic_Bike_Share/bike 2019 q3.csv")
bike_2019_q4 <- read_csv("C:/Users/HP/Downloads/Cyclistic_Bike_Share/Bike trips 2019 Q4.csv")
bike_2020_q1 <- read_csv("C:/Users/HP/Downloads/Cyclistic_Bike_Share/bike trips 2020 q1.csv")
```
...
```{r}
Bike_trips$started_at<-as.POSIXct(Bike_trips$started_at,format="%d/%m/%Y %H:%M")
Bike_trips$ended_at<-as.POSIXct(Bike_trips$ended_at,format="%d/%m/%Y %H:%M")
...
Bike_trips_01<-na.omit(Bike_trips_01)
```
